        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
            <div class="mb-6">
                <a href="/" class="flex items-center gap-3">
                    ...
                    <span class="text-white font-semibold text-xl">SLT WhatsApp</span>
                </a>
            </div>

            <div class="w-full sm:max-w-md px-6 py-8 rounded-2xl bg-white/5 border border-white/10 overflow-hidden">
                {{ $slot }}
            </div>
